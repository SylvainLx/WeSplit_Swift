...
//  WeSplit
//
//  Created by Sylvain Leguay on 30/05/2023.
//
    ...
    var body: some View {
        NavigationView {
            Form {
                ...
                Section {
                    Text(totalPerPerson.amountPerPerson, format: currency)
                } header: {
                    Text("Amount per person")
                }
                
                Section {
                    Text(totalPerPerson.grandTotal, format: currency)
                } header: {
                    Text("Amount per person with Tips")
                }
